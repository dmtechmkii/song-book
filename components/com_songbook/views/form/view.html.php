...
class SongbookViewForm extends JViewLegacy
{
  protected $form = null;
  ...
  function display($tpl = null)
  {
    ...
    if(empty($this->item->id)) {
      $authorised = $user->authorise('core.create', 'com_songbook') || (count($user->getAuthorisedCategories('com_songbook', 'core.create')));
      $this->isNew = 1;
    }
