...
$canOrder = $user->authorise('core.edit.state', 'com_songbook.category');
...
<form action="<?php echo JRoute::_('index.php?option=com_songbook&view=songs');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
	...
	<th>
	<?php echo JHtml::_('searchtools.sort', 'JGLOBAL_TITLE', 's.title', $listDirn, $listOrder); ?>
	</th>
	<th width="10%" class="nowrap hidden-phone">
	  <?php echo JHtml::_('searchtools.sort',  'JGRID_HEADING_ACCESS', 's.access', $listDirn, $listOrder); ?>
	</th>
	<th width="10%" class="nowrap hidden-phone">
	...
	<th width="1%" class="nowrap hidden-phone">
	  <?php echo JHtml::_('searchtools.sort', 'JGLOBAL_HITS', 's.hits', $listDirn, $listOrder); ?>
	</th>
	<th width="1%" class="nowrap hidden-phone">
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 's.id', $listDirn, $listOrder); ?>
      ...
      $canCreate = $user->authorise('core.create', 'com_songbook.category.'.$item->catid);
      $canEdit = $user->authorise('core.edit','com_songbook.song.'.$item->id);
	...
	<td class="order nowrap center hidden-phone">
	  ...
	  <td class="center">
	    <div class="btn-group">
	      <?php echo JHtml::_('jgrid.published', $item->published, $i, 'songs.', $canChange, 'cb'); ?>
	      <?php
	      // Create dropdown items
	      $action = $archived ? 'unarchive' : 'archive';
	      JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'songs');
	  ...
	  <td class="has-context">
	    <div class="pull-left">
		  ...
		  <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'songs.', $canCheckin); ?>
	      <?php endif; ?>
	      <?php if($canEdit || $canEditOwn) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_songbook&task=song.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->title); ?></a>
	      <?php else : ?>
...
<input type="hidden" name="option" value="com_songbook" />
