...
$function = $jinput->get('function', 'jSelectSong');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>

<form action="<?php echo JRoute::_('index.php?option=com_songbook&view=songs&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <fieldset class="filter clearfix">
    <div class="btn-toolbar">
      ...
      <div class="btn-group pull-left">
	      ...
	      title="<?php echo JText::_('COM_SONGBOOK_FILTER_SEARCH_DESC'); ?>" />
      </div>
      <div class="btn-group pull-left">
	...
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_songbook', array('filter.language' => array('*', $this->state->get('filter.forcedLanguage')))), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      ...
      <select name="filter_category_id" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_songbook'), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      <select name="filter_tag" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_TAG');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('tag.options', 'com_songbook'), 'value', 'text', $this->state->get('filter.tag'));?>
      </select>
